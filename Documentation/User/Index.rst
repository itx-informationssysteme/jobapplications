...
Simply create all of these pages and name it as you want. You can leave them be for the moment. We will go over
...
"""""""""""""""""""""""
This settings provides a possibility to not show the title of the location. This is useful if you only want to show the
...
Template Constants
------------------
In the Template Constant Editor the plugin registered a few options.
...
Change CSS Path
~~~~~~~~~~~~~~~
If you want a different Bootsrap.css or even a whole different .css File you can change its path here.
...
You can find these under *Settings->Extension Configuration->Configure Extensions->jobs*.
